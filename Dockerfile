...
COPY entrypoint.sh /onetv-api-entrypoint.sh

COPY config /onetv-api-config
...
RUN chmod +x /onetv-api-entrypoint.sh

ENTRYPOINT /onetv-api-entrypoint.sh
